import { _getProvider, getApp, _registerComponent, registerVersion } from 'https://www.gstatic.com/firebasejs/9.6.7/firebase-app.js';
 ...
 * limitations under the License.
 */
const logger = new Logger('https://www.gstatic.com/firebasejs/9.6.7/firebase-app.js-check');
...
const name = "https://www.gstatic.com/firebasejs/9.6.7/firebase-app.js-check";
const version = "0.5.3";
 ...
 * @param app - the {@link https://www.gstatic.com/firebasejs/9.6.7/firebase-app.js#FirebaseApp} to activate App Check for
